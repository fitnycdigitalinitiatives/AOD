...
<div class="collection-tile">
	<div class="collection-thumb">
		...
		<?php echo link_to_items_browse('<div class="title"><h2>' . metadata('collection', array('Dublin Core', 'Title')) . '</h2><div class="video-count">' . metadata('collection', 'total_items') . '</div></div>', array('collection' => metadata($collection, 'id'))); ?>
	</div>
</div>
<?php endforeach; ?>
</div>
