...
function video_embed()
{
	...
	return '<div class="videoWrapper"><iframe width="560" height="349" src="' . $src . '?autoplay=1?modestbranding=1?showinfo=0?rel=0" frameborder="0" allowfullscreen></iframe></div><div class="drive-link"><a href="' . $href . '">Download Original File (Requires valid fitnyc.edu email)</a></div>'; 
}
