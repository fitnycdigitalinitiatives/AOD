...
<h2><?php echo link_to_items_browse(strip_formatting(metadata('collection', array('Dublin Core', 'Title'))) . '<span>(view all)</span>', array('collection' => metadata($collection, 'id'))); ?></h2>
