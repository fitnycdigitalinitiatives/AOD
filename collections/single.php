<div class="collection record">
    ...
    ?>
    <h3><?php echo link_to_items_browse('<div class="collection-link-thumb">' . $collectionImage . '<div class="description"><h4>' . $title . '</h4><p>' . $description . '</p></div>', array('collection' => metadata($collection, 'id'))); ?></h3>
